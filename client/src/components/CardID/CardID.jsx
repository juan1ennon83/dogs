    ...
    return (
        <div className={style.card}>
            {(modal) && (
                <div className={style.modal}>
                    ...
                    <div className={style.modalContent}>
                        ...
                        < button className={style.buttonConfirm} onClick={() => (clickSubmit())}>CONFIRM</button>
            ...
            {loading ? (<>
                {dog.length === 0 ? (
                    <>
                        <img className={style.img} src="./dogs.jpg" alt="does not exist" />
                        ...
                        <div className={style.container}>
                            ...
                            {dog.from === "DataBase" ? (
                                <div className={style.modDel}>
                                    ...
                                    <button onClick={() => clickHandler()} className={style.buttonDelete} name="Delete">Delete</button>
                                </div>) : null}
                        </div>
                    </>)}
            </>) : (<>
